...
def buffoon_pack_detailed(out: list[object], size: int, ante: int) -> None: ...
...
def next_shop_item(ante: int) -> object: ...
...
def standard_card(ante: int) -> object: ...
def standard_edition(ante: int) -> int: ...
def standard_enhancement(ante: int) -> int: ...
def standard_pack(out: list[object], size: int, ante: int) -> None: ...
